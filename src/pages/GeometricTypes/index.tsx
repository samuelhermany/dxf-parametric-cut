...
const items = [
  ...
  { id: 4, model: 'flange', title: 'flange', isActive: false, img: imgFlange },
  {
    id: 5,
    model: 'trapezoid_5l',
    title: 'trapezio 5l',
  ...
  { id: 6, model: 'ellipse', title: 'elipse', isActive: false, img: imgEllipse },
  ...
  { id: 17, model: 'clip', title: 'presilha', isActive: true, img: imgClip },
  {
    id: 18,
    model: 'washer_square',
    title: 'arruela quadrada',
    isActive: true,
    img: imgWasherSquare,
  },
]

export function GeometricTypes() {
